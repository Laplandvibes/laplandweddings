...
> = {
  ...
  ask3: {
    ...
    'zh-CN': '路费是否包含在内？大多数摄影师常驻罗瓦涅米或莱维，前往萨利色尔卡、基尔皮斯耶尔维或伊纳里的车程另行收费。',
  ...
  whenPeak: {
    ...
    fr: 'Les week-ends les plus demandés',
  ...
  formTitle: {
    ...
    it: 'Richiedete un preventivo per il servizio fotografico di matrimonio',
  ...
  formSub: {
    ...
    sv: 'Samma formulär som på resten av webbplatsen. Fotoönskemålet finns redan i meddelandet; lägg till datum och plats så går det vidare oförändrat till planerare och fotografer.',
  },
  formPreset: {
