...
const P: Record<'seoTitle' | 'seoDesc' | 'title' | 'subtitle' | 'imageAlt' | 'sourceNote', Localized<string>> = {
  ...
  imageAlt: {
    en: 'Wedding couple in winter Lapland — photo: Maria Hedengren',
    fi: 'Hääpari talvisessa Lapissa — kuva: Maria Hedengren',
    de: 'Hochzeitspaar im winterlichen Lappland — Foto: Maria Hedengren',
    ja: '冬のラップランドの結婚式カップル — 撮影：Maria Hedengren',
    es: 'Pareja de novios en la Laponia invernal — foto: Maria Hedengren',
    'pt-BR': 'Casal de noivos na Lapônia no inverno — foto: Maria Hedengren',
    'zh-CN': '冬季拉普兰的新婚夫妇——摄影：Maria Hedengren',
    ko: '겨울 라플란드의 신혼부부 — 사진: Maria Hedengren',
    fr: 'Couple de mariés en Laponie hivernale — photo : Maria Hedengren',
    it: 'Coppia di sposi nella Lapponia invernale — foto: Maria Hedengren',
    nl: 'Bruidspaar in winters Lapland — foto: Maria Hedengren',
  },
  sourceNote: {
