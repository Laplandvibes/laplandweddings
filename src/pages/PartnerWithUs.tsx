  ...
  },
  {
    ...
    data: {
      ...
      label: {
        ...
        nl: 'talen: stellen uit het VK, Azië en Centraal-Europa vinden je', sv: 'språk: par från Storbritannien, Asien och Centraleuropa hittar dig',
      },
    },
  },
  {
...
const valueProps: { icon: typeof Inbox; data: Card }[] = [
  {
    ...
    data: {
      ...
      body: {
        ...
        es: 'Cada lead incluye presupuesto, fechas, número de invitados, tipo de ceremonia y región, a menudo también fotos de inspiración. Recibes una pareja que busca activamente lo que ofreces.',
  ...
  },
  {
    ...
    data: {
      ...
      body: {
        ...
        es: 'Primer lead gratis, sin cuota mensual, sin coste de configuración. Ves la calidad antes de pagar un céntimo.',
  ...
  },
  {
    ...
    data: {
      title: {
        ...
        nl: 'De klantrelatie is van jou', sv: 'Du äger kundrelationen',
      },
      body: {
        ...
        es: 'Nosotros derivamos el lead; tú contactas a la pareja directamente, presupuestas y cierras. La pareja es tu cliente desde el primer hola hasta el último baile.',
...
const steps: Step[] = [
  {
    ...
    title: {
      ...
      fr: 'Postulez pour rejoindre', it: 'Candidati per entrare', nl: 'Meld je aan', sv: 'Ansök om att gå med',
    },
    body: {
      ...
      es: 'Rellena el formulario de abajo. Confirmamos que puedes encargarte de toda la boda, por ti mismo o a través de socios consolidados.',
  ...
  },
  {
    ...
    title: {
      ...
      fr: 'Recevez des leads adaptés', it: 'Ricevi lead pertinenti', nl: 'Ontvang passende leads', sv: 'Få matchade leads',
    },
    body: {
  ...
  },
  {
    ...
    title: {
      ...
      fr: 'Conquérez le couple', it: 'Conquista la coppia', nl: 'Win het stel voor je', sv: 'Vinn paret',
    },
    body: {
      ...
      es: 'Contactas a la pareja directamente, presupuestas y cierras. Tú llevas la boda de principio a fin.',
...
const expectations: Card[] = [
  {
    ...
    body: {
      ...
      es: 'Puedes encargarte de toda la boda, lugar, ceremonia, catering, fotografía, alojamiento, traslados, por ti mismo o a través de socios de confianza.',
  ...
  },
  {
    ...
    body: {
      ...
      es: 'Un operador consolidado con sede en Finlandia o el Reino Unido y bodas reales en Laponia a tus espaldas.',
      ...
      nl: 'Een gevestigde aanbieder uit Finland of het VK met echte Laplandse bruiloften op je naam.', sv: 'En etablerad aktör i Finland eller Storbritannien med riktiga lappländska bröllop bakom sig.',
    },
  },
  {
    title: {
    ...
    body: {
      ...
      es: 'Respondes a un lead en 1–7 días y te encargas de la pareja de principio a fin, incluidos los trámites del DVV.',
...
const terms: Card[] = [
  {
    ...
    body: {
      ...
      es: 'Toda colaboración parte de un acuerdo escrito sencillo que repasamos juntos antes de tu primer lead. Sin cuotas mensuales, sin permanencia: solo condiciones justas para ambas partes.',
  ...
  },
  {
    ...
    body: {
      ...
      es: 'Mejoramos continuamente la calidad de los leads, pero las parejas introducen sus propios datos y no podemos garantizar cada lead. Una vez entregado el lead, atender a la pareja, y la responsabilidad de ello, pasa a ti. La relación es tuya de principio a fin.',
  ...
  },
  {
    ...
    body: {
      ...
      es: 'Si un lead resulta claramente inválido, datos de contacto erróneos o no es una consulta genuina, avísanos y lo abonamos contra tu próximo lead. Solo pagas por parejas reales.',
...
const C: Record<CKey, Localized<string>> = {
  seoTitle: {
    ...
    es: 'Hazte socio: leads de bodas en Laponia | LaplandWeddings',
  ...
  seoDesc: {
    ...
    es: 'Hazte socio de LaplandWeddings: leads de bodas de Laponia cualificados todo el año, pagas solo por los leads que recibes, sin cuota mensual. Primer lead gratis.',
  ...
  heroSubtitle: {
    ...
    es: 'Leads de bodas de Laponia cualificados directamente en tu bandeja de entrada, de la aurora boreal al sol de medianoche, todo el año. Pagas solo por los leads que recibes.',
  ...
  heroCta: {
    ...
    fr: 'Postuler pour rejoindre le réseau', it: 'Candidati per entrare nella rete', nl: 'Meld je aan voor het netwerk', sv: 'Ansök om att gå med i nätverket',
  },
  conceptEyebrow: {
  ...
  conceptSubtitle: {
    ...
    es: 'LaplandWeddings forma parte de la red LaplandVibes. Cuando un viajero planea un viaje a Laponia, alojamiento, un safari de huskies, una cena, vuelos, aterriza en nuestros sitios. Quienes sueñan con una boda son dirigidos a un único formulario, y ese formulario llega a ti.',
  ...
  whyEyebrow: {
    ...
    fr: 'Pourquoi rejoindre', it: 'Perché unirti', nl: 'Waarom meedoen', sv: 'Varför gå med',
  },
  whyTitle: {
  ...
  whySubtitle: {
    ...
    es: 'Tú haces lo que mejor sabes hacer. Nosotros llevamos las parejas hasta tu puerta.',
    ...
    nl: 'Jij doet waar je het beste in bent; wij brengen de stellen naar je toe.', sv: 'Du gör det du är bäst på. Vi för paren till din dörr.',
  },
  howEyebrow: {
  ...
  priceTitle: {
    ...
    nl: 'Je eerste lead is gratis', sv: 'Ditt första lead är gratis',
  },
  priceSubtitle: {
    ...
    es: 'Sin cuotas mensuales, sin coste de configuración. Elige el modelo que te convenga.',
    ...
    nl: 'Geen maandelijkse kosten, geen opstartkosten. Kies het model dat bij je past.', sv: 'Inga månadsavgifter, ingen startkostnad. Välj den modell som passar dig.',
  },
  sharedLead: {
  ...
  sharedBody: {
    ...
    es: 'Pagas solo por los leads que recibes: parejas reales que buscan activamente lo que ofreces. Cada lead se comparte con un máximo de tres socios, así la competencia es justa. Tu primer lead es gratis.',
  ...
  exclusiveBody: {
    ...
    es: 'La pareja es solo tuya; el mismo lead no va a nadie más. Sencillo: sabes exactamente lo que pagas y dedicas a la pareja toda tu atención sin competencia.',
  ...
  priceFooter: {
    ...
    es: 'Precios sencillos: siempre pagas por lead, nunca por venta. Sin cuotas mensuales, sin seguimiento de porcentajes, sin permanencia. Cancela cuando quieras.',
  ...
  applyEyebrow: {
    ...
    fr: 'Postuler', it: 'Candidati', nl: 'Aanmelden', sv: 'Ansök',
  },
  applyTitle: {
    ...
    fr: 'Rejoindre le réseau', it: 'Entra nella rete', nl: 'Word lid van het netwerk', sv: 'Gå med i nätverket',
  },
  applySubtitle: {
    ...
    es: 'Cuéntanos sobre ti. Respondemos en unos días. Los socios aprobados reciben su primer lead gratis.',
