          ...
          {[
            {
              ...
              body: pick(lang, {
                ...
                sv: 'Ett hundspann drar pulkan genom snön i granskogen. Många par tar sig den sista biten till vigseln just så.',
              }),
            },
            {
              ...
              body: pick(lang, {
                ...
                es: 'El lago Inari se hiela tanto que los barcos se quedan en su sitio todo el invierno. De noche las estrellas trazan arcos y la aurora se alza sobre el hielo.',
                'pt-BR': 'O lago Inari congela a ponto de os barcos ficarem parados o inverno inteiro. À noite as estrelas desenham arcos e a aurora sobe acima do gelo.',
                'zh-CN': '伊纳里湖结冰之厚，让船整个冬天都留在原地。夜里星辰划出弧线，极光在冰面上方升起。',
                ko: '이나리 호수는 배가 겨우내 그대로 얼어붙을 만큼 단단히 업니다. 밤이면 별이 호를 그리고 얼음 위로 오로라가 떠오릅니다.',
                fr: 'Le lac Inari gèle au point que les bateaux restent sur place tout l’hiver. La nuit, les étoiles tracent des arcs et l’aurore se lève au-dessus de la glace.',
                it: 'Il lago Inari gela a tal punto che le barche restano ferme per tutto l’inverno. Di notte le stelle disegnano archi e l’aurora sale sopra il ghiaccio.',
            ...
            },
            {
              ...
              body: pick(lang, {
                ...
                nl: 'Een rooksauna wordt uren voorverwarmd voor de eerste stoom. Vandaar stap je blootsvoets de sneeuw in — de Finse manier.',
            ...
            },
            {
              ...
              body: pick(lang, {
                ...
                nl: 'Het wak blijft de hele winter open: steiger, trap en reddingsboei klaar. Er in je jurk in stappen is de foto die rondgaat.',
