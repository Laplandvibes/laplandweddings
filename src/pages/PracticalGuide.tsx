...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    p: {
      ...
      it: 'La cerimonia civile è la più comune: un ufficiale del DVV a Rovaniemi, Inari, Kittilä o Sodankylä. Il celebrante anglofono è di solito organizzato dal tuo planner. Cerimonia religiosa solo per i membri di una comunità religiosa registrata, come la Chiesa luterana.',
  ...
  },
  {
    ...
    p: {
      ...
      it: 'Porta il certificato con apostille all’anagrafe del tuo Paese d’origine. Nei Paesi UE di solito entro un mese. Da quel momento il matrimonio è registrato sia nel tuo Paese sia in Finlandia.',
...
const UI: Record<string, Localized<string>> = {
  ...
  stepsIntro: {
    ...
    it: 'Tra voi e un matrimonio riconosciuto sia nel vostro Paese sia in Finlandia ci sono sei passaggi burocratici; la maggior parte delle coppie li completa in 4-8 settimane, insieme a tutto il resto.',
...
const FAQ: { q: Localized<string>; a: Localized<string> }[] = [
  ...
  },
  {
    ...
    a: {
      ...
      nl: 'Februari-maart bieden de langste daglichturen, de betrouwbaarste sneeuw en het noorderlicht. December is het sfeervolst.', sv: 'February and March are the best balance of daylight, reliable snow and Northern Lights. December is the most atmospheric.',
    },
  },
];
