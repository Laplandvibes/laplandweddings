...
const STEPS: Step[] = [
  {
    ...
    t: {
      ...
      ja: 'DVVに婚姻障害の調査を申請する',
      es: 'Solicite el Examen de Impedimentos al DVV',
      'pt-BR': 'Solicite o Exame de Impedimentos ao DVV',
      'zh-CN': '向DVV申请婚姻障碍审查',
      ko: 'DVV에 혼인 요건 심사를 신청하세요',
    ...
    p: {
      ...
      es: 'Parejas finlandesas: 1-2 semanas. Parejas extranjeras: 3-5 semanas. Gratis (salvo 15 € de traducción UE si hace falta). Preséntelo 2 meses antes de la boda.',
      ...
      nl: 'Finse stellen: 1-2 weken. Buitenlandse stellen: 3-5 weken. Gratis (behalve € 15 EU-vertaling indien nodig). Dien 2 maanden voor de bruiloft in.', sv: 'Finländska par: 1–2 veckor. Utländska par: 3–5 veckor. Gratis (förutom 15 € EU-översättning vid behov). Lämna in ansökan 2 månader före bröllopet.',
    },
  ...
  },
  {
    ...
    t: {
      ...
      es: 'Obtenga un Certificado de No Impedimento en su país de origen',
    ...
    p: {
      ...
      es: 'Solicítelo a su registro civil o ministerio de exteriores antes de llegar a Finlandia. La mayoría de los países exigen apostilla y traducción jurada.',
      ...
      nl: 'Vraag het aan bij uw burgerlijke stand of ministerie van Buitenlandse Zaken voordat u in Finland aankomt. De meeste landen vereisen een apostille en een beëdigde vertaling.', sv: 'Begär intyget från ert hemlands folkbokföring eller utrikesministerium innan ni anländer till Finland. De flesta länder kräver en apostillestämpel och en auktoriserad översättning.',
    },
  ...
  },
  {
    ...
    p: {
      ...
      es: 'La ceremonia civil es la más habitual: un oficiante del DVV en Rovaniemi, Inari, Kittilä o Sodankylä. El oficiante anglófono suele gestionarlo su organizador. La ceremonia religiosa solo para miembros de una comunidad religiosa registrada, como la Iglesia luterana.',
      ...
      ko: '민사 예식이 가장 일반적입니다: 로바니에미, 이나리, 키틸래, 소단퀼래의 DVV 등록관이 진행합니다. 영어가 가능한 주례는 보통 플래너가 섭외합니다. 종교 예식은 루터교회 등 등록된 종교 단체의 신자만 가능합니다.',
      ...
      nl: 'De burgerlijke ceremonie is het meest gangbaar: een ambtenaar van de DVV in Rovaniemi, Inari, Kittilä of Sodankylä. Een Engelstalige voltrekker wordt meestal door uw planner geregeld. Een kerkelijke ceremonie alleen voor leden van een geregistreerd kerkgenootschap, zoals de Lutherse Kerk.', sv: 'En borgerlig vigsel är vanligast: en vigselförrättare från DVV i Rovaniemi, Inari, Kittilä eller Sodankylä. En engelsktalande vigselförrättare ordnas oftast av er planerare. En kyrklig vigsel är bara öppen för medlemmar i ett registrerat trossamfund, till exempel Lutherska kyrkan.',
    },
  },
  {
    n: 4,
    ...
    p: {
      ...
      ko: '핀란드 법은 증인 2명을 요구합니다. 대부분의 예식장과 플래너가 현장에서 마련하며, 핀란드인일 필요는 없습니다.',
      ...
      nl: 'De Finse wet vereist twee getuigen. De meeste locaties en planners regelen ze ter plaatse. Ze hoeven niet Fins te zijn.', sv: 'Finsk lag kräver två vittnen. De flesta platser och planerare ordnar dem på plats. De behöver inte vara finländska.',
    },
  },
  {
    n: 5,
    ...
    p: {
      ...
      es: 'Recibirá 2 certificados de matrimonio oficiales en inglés. La apostilla a través del DVV es rápida y la exigen la mayoría de los países de origen.',
      ...
      nl: 'U ontvangt 2 officiële huwelijksakten in het Engels. De apostille via het DVV gaat snel, vereist door de meeste thuislanden.', sv: 'Ni får 2 officiella vigselbevis på engelska. En apostille från DVV går snabbt att få och krävs av de flesta hemländer.',
    },
  ...
  },
  {
    ...
    t: {
      ...
      ja: '母国で婚姻を登録する',
      es: 'Registre el matrimonio en su país de origen',
    ...
    p: {
      ...
      es: 'Lleve el certificado apostillado al registro de su país de origen. En países de la UE suele ser en un mes. Tras ello, el matrimonio queda inscrito tanto en su país como en Finlandia.',
      ...
      nl: 'Lever de geapostilleerde akte in bij het register van uw thuisland. In EU-landen meestal binnen een maand. Daarna is het huwelijk zowel in uw eigen land als in Finland geregistreerd.', sv: 'Ta det apostillerade vigselbeviset till ert hemlands folkbokföring. I EU-länder tar det oftast inom en månad. Äktenskapet är då registrerat både hemma och i Finland.',
    },
  },
];
...
const UI: Record<string, Localized<string>> = {
  ...
  routesIntro: {
    ...
    es: 'Tome primero esta decisión, porque determina si necesita algún trámite oficial.',
  ...
  symbolicBody: {
    ...
    de: 'So machen es die meisten Paare, die nach Lappland kommen. Die Zeremonie findet auf dem Eis, in einer Schneekapelle oder auf einem Fjällgipfel statt, die Ehe wird vor oder nach der Reise in der Heimat rechtsgültig geschlossen. Keine Genehmigungen, keine Ehefähigkeitsprüfung, kein DVV, und das Datum können Sie frei festlegen. Die Schritte unten betreffen Sie nicht.',
    ...
    es: 'Es lo que hace la mayoría de las parejas que vienen a Laponia. La ceremonia se celebra sobre el hielo, en una capilla de nieve o en lo alto de un fell, y el matrimonio se registra legalmente en casa antes o después del viaje. Sin permisos, sin examen de impedimentos, sin DVV, y puede fijar la fecha cuando quiera. Los pasos de abajo no le afectan.',
    'pt-BR': 'É o que faz a maioria dos casais que vem à Lapônia. A cerimônia acontece no gelo, em uma capela de neve ou no alto de um monte, e o casamento é registrado legalmente em casa antes ou depois da viagem. Sem licenças, sem exame de impedimentos, sem DVV, e vocês marcam a data quando quiserem. Os passos abaixo não se aplicam a vocês.',
    'zh-CN': '来拉普兰的大多数情侣都这样做。仪式在冰面上、雪教堂或山顶举行，法律意义上的结婚则在出行前后于本国登记。无需许可、无需婚姻障碍审查、无需 DVV，日期也可以随意确定。下面的步骤与你们无关。',
    ko: '라플란드를 찾는 대부분의 커플이 택하는 방식입니다. 예식은 얼음 위나 스노우 채플, 또는 펠 정상에서 올리고, 법적 혼인은 여행 전후에 본국에서 신고합니다. 허가도, 혼인 요건 심사도, DVV도 필요 없으며 날짜도 원하는 대로 정할 수 있습니다. 아래 절차는 해당되지 않습니다.',
    fr: 'C’est ce que font la plupart des couples qui viennent en Laponie. La cérémonie a lieu sur la glace, dans une chapelle de neige ou au sommet d’un fjäll, et le mariage est enregistré légalement dans votre pays avant ou après le voyage. Aucune autorisation, aucun examen des empêchements, aucun DVV, et vous fixez la date quand vous voulez. Les étapes ci-dessous ne vous concernent pas.',
  ...
  legalBody: {
    ...
    es: 'También es posible para parejas extranjeras, pero es un añadido, no la opción por defecto. Solo el DVV, un juzgado y las comunidades religiosas registradas pueden oficiar el matrimonio; nosotros no. Antes de la ceremonia se exige el examen de impedimentos, y lleva semanas: certificado de capacidad matrimonial de su país, a menudo apostilla y traducción jurada. Planifíquelo antes de fijar la fecha. Los pasos de abajo describen esta vía.',
    ...
    ko: '외국인 커플에게도 가능하지만, 기본이 아니라 추가 선택지입니다. 혼인을 집전할 수 있는 곳은 DVV와 지방법원, 등록된 종교 단체뿐이며 저희에게는 그 권한이 없습니다. 예식 전에 혼인 요건 심사가 필요하고 여기에 몇 주가 걸립니다. 본국의 혼인요건증명서, 많은 경우 아포스티유와 공인 번역도 필요합니다. 날짜를 확정하기 전에 이 기간을 계산해 두세요. 아래 절차는 이 경로에 관한 것입니다.',
  ...
  seoDescription: {
    ...
    ko: '외국인 커플을 위한 실용 가이드: DVV 서류, 혼인 요건 심사(3~5주), 증인, 주례, 본국 등록.',
    ...
    nl: 'Praktische gids voor buitenlandse stellen: DVV-papierwerk, onderzoek naar huwelijksbeletselen (3-5 weken), getuigen, voltrekker, registratie in het thuisland.', sv: 'Praktisk guide för utländska par: DVV-papper, hindersprövning (3–5 veckor), vittnen, vigselförrättare och registrering i hemlandet.',
  },
  howToName: {
  ...
  eyebrow: {
    ...
    es: 'Su boda en Laponia: guía práctica',
  ...
  downloadEyebrow: {
    ...
    ja: 'チェックリストをダウンロード',
    es: 'Descargue la lista de verificación',
  ...
  downloadDesc: {
    ...
    es: 'Imprímala o guárdela para su carpeta de viaje: todos los pasos desde 8 semanas antes hasta después de la boda.',
  ...
  stepsIntro: {
    ...
    es: 'Entre usted y un matrimonio reconocido tanto en su país como en Finlandia hay seis pasos de papeleo; la mayoría de las parejas los resuelve en 4-8 semanas junto con todo lo demás.',
    ...
    nl: 'Tussen u en een huwelijk dat zowel thuis als in Finland erkend is staan zes stappen papierwerk; de meeste stellen ronden ze in 4-8 weken af, naast al het andere.', sv: 'Sex steg med pappersarbete står mellan er och ett äktenskap som är erkänt både hemma och i Finland. De flesta par klarar dem på 4–8 veckor vid sidan av allt annat.',
  },
  guestsTitle: {
  ...
  carBody: {
    ...
    es: 'Alquile un coche directamente en el aeropuerto de Rovaniemi, Kittilä o Ivalo: nuestro sitio de la red, laplandcarrental.com, ofrece precios y reservas en finlandés e inglés.',
    ...
    ko: '로바니에미, 키틸래, 이발로 공항에서 바로 차를 빌리세요. 네트워크 사이트 laplandcarrental.com에서 핀란드어와 영어로 요금과 예약을 제공합니다.',
    ...
    nl: 'Huur een auto direct op de luchthaven van Rovaniemi, Kittilä of Ivalo. Onze netwerksite laplandcarrental.com biedt prijzen en reserveringen in het Fins en Engels.', sv: 'Hyr bil direkt på flygplatsen i Rovaniemi, Kittilä eller Ivalo. Vår nätverkssajt laplandcarrental.com erbjuder priser och bokning på finska och engelska.',
  },
  flightsFromLondon: {
...
const GUEST_CARDS: GuestCard[] = [
  {
    ...
    p: {
      ...
      es: 'El organizador presupuesta la boda en sí: ceremonia, espacio, programa y proveedores. Los vuelos y las habitaciones de hotel se reservan aparte, normalmente antes incluso de empezar a planificar la boda. Aquí nadie vende vuelos; esta guía le dice qué reservar y cuándo.',
      ...
      ko: '플래너가 견적을 내는 것은 결혼식 그 자체입니다: 예식, 예식장, 프로그램, 업체 섭외. 항공편과 호텔 객실은 별도로 예약하며, 보통 웨딩 플래닝이 시작되기 전에 이루어집니다. 이곳에서는 항공권을 판매하지 않습니다. 무엇을 언제 예약해야 하는지는 이 가이드가 알려드립니다.',
      ...
      nl: 'De planner begroot de bruiloft zelf: ceremonie, locatie, programma, leveranciers. Vluchten en hotelkamers boekt u apart, meestal nog voordat de bruiloftsplanning begint. Hier verkoopt niemand vluchten; deze gids vertelt u wat u wanneer moet boeken.', sv: 'Planeraren prissätter själva bröllopet: ceremoni, lokal, program, leverantörer. Flyg och hotellrum bokas separat, oftast innan bröllopsplaneringen ens börjar. Ingen här säljer flyg, den här guiden berättar bara vad ni ska boka och när.',
    },
  },
  {
    icon: Users,
    ...
    p: {
      ...
      es: 'En las bodas de destino, los invitados suelen pagar sus vuelos y su alojamiento: dígalo con claridad en la invitación. Si quiere invitar a una parte (por ejemplo, la cena nupcial y una actividad), indíquelo en la solicitud y los organizadores lo incluirán en el presupuesto desde el primer día.',
      ...
      nl: 'Bij een bruiloft in het buitenland betalen gasten normaal gesproken hun eigen vluchten en verblijf. Zeg dat duidelijk in de uitnodiging. Wilt u een deel aanbieden (bijvoorbeeld het bruiloftsdiner en één activiteit), vermeld dat dan in uw aanvraag; de planners zetten het vanaf dag één in het budget.', sv: 'Vid destinationsbröllop står gästerna vanligtvis för sina egna flyg och sitt eget boende. Säg det tydligt på inbjudan. Vill ni bjuda på en del (till exempel bröllopsmiddagen och en aktivitet), säg det i förfrågan, så räknar planerarna in det från början.',
    },
  },
  {
    icon: Palette,
    t: {
      ...
      ja: 'ご希望ならテーマと装飾も',
      es: 'Tema y estética, si lo desea',
    ...
    p: {
      ...
      es: 'Un organizador también puede diseñar el tema con usted: colores, flores, montaje de mesa e hilo del programa; para que todo el fin de semana se sienta como una sola historia y no como una lista de reservas.',
      ...
      nl: 'Een planner kan ook samen met u het thema ontwerpen: kleuren, bloemen, tafelstyling en de opbouw van het programma, zodat het hele weekend als één verhaal voelt in plaats van een lijst boekingen.', sv: 'En planerare kan även utforma temat tillsammans med er: färger, blommor, bordsdukning och programmets uppbyggnad, så att hela helgen känns som en enda berättelse i stället för en lista bokningar.',
    },
  },
];
...
const SEASONS: SeasonCard[] = [
  ...
  },
  {
    ...
    body: {
      fi: 'Keskiyön aurinko 23.5.–24.7. Lämmin (15–25 °C), ei lunta. Hyttyset huipussaan kesäkuun lopulta heinäkuuhun.',
      en: 'Midnight Sun 23 May – 24 July. Warm (15–25 °C), no snow. Mosquitoes peak from late June into July.',
      de: 'Mitternachtssonne vom 23. Mai bis 24. Juli. Mild (15–25 °C), kein Schnee. Mückenhochsaison von Ende Juni bis Juli.',
      ja: '白夜は5月23日〜7月24日。温暖（15〜25℃）で雪はなし。蚊は6月下旬から7月がピーク。',
      es: 'Sol de medianoche del 23 de mayo al 24 de julio. Cálido (15-25 °C), sin nieve. Pico de mosquitos de finales de junio a julio.',
      'pt-BR': 'Sol da meia-noite de 23 de maio a 24 de julho. Ameno (15-25 °C), sem neve. Pico de mosquitos do fim de junho a julho.',
      'zh-CN': '午夜阳光为5月23日至7月24日。气候温暖（15–25°C），无积雪。蚊虫在6月下旬至7月达到高峰。',
      ko: '백야는 5월 23일~7월 24일. 온화함(15~25°C), 눈 없음. 모기는 6월 말부터 7월까지 절정.',
      fr: 'Soleil de minuit du 23 mai au 24 juillet. Doux (15-25 °C), sans neige. Pic de moustiques de fin juin à juillet.',
      it: 'Sole di mezzanotte dal 23 maggio al 24 luglio. Mite (15-25 °C), niente neve. Picco di zanzare da fine giugno a luglio.',
      nl: 'Middernachtzon van 23 mei tot 24 juli. Mild (15-25 °C), geen sneeuw. Muggenpiek van eind juni tot juli.', sv: 'Midnattssol 23 maj – 24 juli. Varmt (15–25 °C), ingen snö. Myggen är som värst från slutet av juni till juli.',
    },
  },
  {
    ...
    body: {
      ...
      nl: 'De ruska (herfstkleuren) medio september, de kleurrijkste tijd van Lapland. Het noorderlicht is al te zien op heldere septembernachten.', sv: 'Ruska (höstfärgerna) i mitten av september är Lapplands mest färgsprakande tid. Norrsken syns redan under klara septembernätter.',
    },
  },
];
...
const FAQ: { q: Localized<string>; a: Localized<string> }[] = [
  {
    ...
    a: {
      ...
      es: '3-5 semanas. Para ciudadanos finlandeses, 1-2 semanas. Empiece el proceso al menos 2 meses antes de la boda.',
  ...
  },
  {
    ...
    a: {
      ...
      ko: '정확히 두 명입니다. 대부분의 예식장과 플래너가 현장에서 마련하며, 핀란드인일 필요는 없습니다.',
  ...
  },
  {
    ...
    a: {
      ...
      es: 'Sí. Recibirá 2 certificados oficiales en inglés. La mayoría de los países de origen exigen la apostilla del DVV, que se obtiene rápido.',
      ...
      nl: 'Ja. U ontvangt 2 officiële akten in het Engels. De meeste thuislanden vereisen een apostille via het DVV, snel te verkrijgen.', sv: 'Ja. Ni får 2 officiella intyg på engelska. De flesta hemländer kräver apostille från DVV, som går snabbt att få.',
    },
  },
  {
    q: {
  ...
  },
  {
    ...
    a: {
      ...
      es: 'Febrero y marzo son el mejor equilibrio entre luz, nieve fiable y auroras. Diciembre es el que tiene más encanto.',
      ...
      nl: 'Februari en maart bieden de beste balans tussen daglicht, betrouwbare sneeuw en noorderlicht. December is het sfeervolst.', sv: 'Februari och mars ger den bästa balansen mellan dagsljus, pålitligt snötäcke och norrsken. December har den mest stämningsfulla känslan.',
    },
  },
];
