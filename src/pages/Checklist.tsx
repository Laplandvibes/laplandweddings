...
const CONTENT: Localized<ChecklistContent> = {
  ...
  de: {
    ...
    intro: 'Finnland macht Hochzeiten für Ausländer einfach. Über die DVV dauert der Papierkram 3–5 Wochen. Beginnen Sie mindestens 2 Monate vor der Hochzeit.',
    ...
    items: [
      ...
      { sec: 'B', do: '2 Trauzeugen sicherstellen', why: 'Das finnische Recht verlangt genau zwei. Sie müssen keine Finnen sein. Die meisten Locations stellen sie vor Ort.' },
      ...
      { sec: 'C', do: 'Zeitplan der Zeremonie mit der Location bestätigen', why: 'In Schneekapellen herrschen -3 bis -7 °C. Planen Sie für die Zeremonie 15–30 Minuten ein.' },
  ...
  es: {
    ...
    intro: 'Finlandia facilita las bodas de extranjeros: los trámites tardan de 3 a 5 semanas a través del DVV. Empiece el proceso al menos 2 meses antes de la boda.',
    sectionA: 'A · 8 semanas antes',
    sectionB: 'B · 4–6 semanas antes',
    sectionC: 'C · La semana de la boda',
    sectionD: 'D · Después de la boda',
    printNote: 'Esta página está optimizada para impresión en A4. Pulse Imprimir o guárdela como PDF.',
    footerNote: 'Parte de la red LaplandVibes · info@laplandvibes.com · Actualizado 2026',
    items: [
      { sec: 'A', do: 'Solicite al DVV el Examen de Impedimentos', why: 'Necesario antes de poder celebrar la ceremonia. Gratuito.', link: DVV_LINK },
      { sec: 'A', do: 'Solicite un Certificado de No Impedimento en su país de origen', why: 'Requerido en la mayoría de los países. Incluya apostilla y traducción jurada si el documento no está en inglés, finlandés o sueco.' },
      { sec: 'A', do: 'Contrate a un organizador de bodas o a un lugar en Laponia', why: 'Confirman el oficiante, los testigos y el plan de documentación.' },
      { sec: 'B', do: 'Envíe el CNI + el examen de impedimentos al DVV', why: 'El DVV confirma que pueden casarse. 3–5 semanas para parejas extranjeras.' },
      { sec: 'B', do: 'Confirme el oficiante y sus conocimientos de idiomas', why: 'Su organizador suele encargarse de un oficiante de habla inglesa.' },
      { sec: 'B', do: 'Asegure 2 testigos', why: 'La ley finlandesa exige exactamente dos. No tienen que ser finlandeses. La mayoría de los lugares los proporcionan in situ.' },
      { sec: 'C', do: 'Confirme los traslados al aeropuerto y el alojamiento de los invitados', why: 'El frío de Laponia puede sorprender: un punto de llegada cálido es importante para los invitados.' },
      { sec: 'C', do: 'Confirme el horario de la ceremonia con el lugar', why: 'Las capillas de nieve están a –3 a –7 °C: mantenga las ceremonias en 15–30 min.' },
      { sec: 'D', do: 'Obtenga 2 certificados de matrimonio oficiales en inglés', why: 'Necesarios para el registro en su país de origen. Del DVV.' },
      { sec: 'D', do: 'Consiga una apostilla del DVV', why: 'Necesaria para el reconocimiento en su país de origen.' },
      { sec: 'D', do: 'Registre el matrimonio en su país de origen', why: 'En los países de la UE, normalmente en un mes. Después, el matrimonio queda inscrito en su país y en Finlandia.' },
    ],
  },
  'pt-BR': {
  ...
  ko: {
    ...
    printBtn: '인쇄 또는 PDF으로 저장',
    intro: '핀란드는 외국인 결혼 절차가 간편합니다. DVV를 통한 서류 처리에 3~5주가 걸립니다. 결혼식 최소 2개월 전에 절차를 시작하세요.',
    sectionA: 'A · 8주 전',
    sectionB: 'B · 4~6주 전',
    sectionC: 'C · 결혼식 주간',
    sectionD: 'D · 결혼식 후',
    printNote: '이 페이지는 A4 인쇄에 최적화되어 있습니다. 인쇄를 누르거나 PDF으로 저장하세요.',
  ...
  it: {
    ...
    printBtn: 'Stampi o salvi in PDF',
    intro: 'La Finlandia rende semplici i matrimoni per gli stranieri. La documentazione richiede 3–5 settimane tramite il DVV. Avvii la procedura almeno 2 mesi prima del matrimonio.',
    ...
    printNote: 'Questa pagina è ottimizzata per la stampa in A4. Prema Stampa oppure salvi la pagina in PDF.',
    footerNote: 'Parte della rete LaplandVibes · info@laplandvibes.com · Aggiornato 2026',
    items: [
      { sec: 'A', do: 'Richieda al DVV l’esame degli impedimenti', why: 'Necessario prima che la cerimonia possa essere celebrata. Gratuito.', link: DVV_LINK },
      { sec: 'A', do: 'Richieda un certificato di nulla osta (CNI) nel Suo Paese di origine', why: 'Richiesto nella maggior parte dei Paesi. Alleghi apostille e traduzione giurata se il documento non è in inglese, finlandese o svedese.' },
      { sec: 'A', do: 'Ingaggi un wedding planner o una location in Lapponia', why: 'Confermano il celebrante, i testimoni e il piano dei documenti.' },
      { sec: 'B', do: 'Invii il CNI + l’esame degli impedimenti al DVV', why: 'Il DVV conferma il diritto a sposarsi. 3–5 settimane per le coppie straniere.' },
      { sec: 'B', do: 'Confermi il celebrante e le sue competenze linguistiche', why: 'Un celebrante che parla inglese viene normalmente organizzato dal Suo planner.' },
      { sec: 'B', do: 'Trovi due testimoni', why: 'La legge finlandese ne richiede esattamente due. Non devono essere finlandesi. La maggior parte delle location li fornisce sul posto.' },
      { sec: 'C', do: 'Confermi i transfer dall’aeroporto e l’alloggio degli ospiti', why: 'Il freddo della Lapponia può sorprendere. Un punto d’arrivo caldo è importante per gli ospiti.' },
      { sec: 'C', do: 'Confermi l’orario della cerimonia con la location', why: 'Le cappelle di neve sono a –3 / –7 °C. Mantenga le cerimonie su 15–30 min.' },
      { sec: 'D', do: 'Ottenga 2 certificati di matrimonio ufficiali in inglese', why: 'Necessari per la registrazione nel Paese di origine. Dal DVV.' },
      { sec: 'D', do: 'Ottenga un’apostille dal DVV', why: 'Necessaria per il riconoscimento nel Suo Paese di origine.' },
      { sec: 'D', do: 'Registri il matrimonio nel Suo Paese di origine', why: 'Nei Paesi UE di solito entro un mese. Da quel momento il matrimonio è registrato nel Suo Paese e in Finlandia.' },
    ],
  },
  nl: {
    ...
    items: [
      ...
      { sec: 'A', do: 'Vraag in uw eigen land een verklaring van geen huwelijksbeletsel (CNI) aan', why: 'In de meeste landen vereist. Voeg een apostille en beëdigde vertaling toe als het document niet in het Engels, Fins of Zweeds is.' },
      ...
      { sec: 'B', do: 'Stuur de CNI + het onderzoek naar beletselen naar de DVV', why: 'De DVV bevestigt dat u mag trouwen. 3–5 weken voor buitenlandse stellen.' },
      { sec: 'B', do: 'Bevestig de voltrekker en diens taalvaardigheid', why: 'Een Engelstalige voltrekker wordt meestal door uw planner geregeld.' },
      ...
      { sec: 'D', do: 'Haal 2 officiële huwelijksakten in het Engels op', why: 'Nodig voor registratie in uw eigen land. Van de DVV.' },
      { sec: 'D', do: 'Vraag een apostille aan bij de DVV', why: 'Nodig voor erkenning in uw eigen land.' },
