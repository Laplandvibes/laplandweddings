...
const stories: Story[] = [
  ...
  },
  {
    ...
    range: '€78 000',
    story: {
      en: 'A wedding for 80 guests at Kakslauttanen Celebration House — Finland’s largest log building, capacity 250. Helicopter transfers from Ivalo airport, Michelin-trained chef, glass igloo nights for every couple, and a four-day programme: arrival sauna, ceremony, post-wedding husky safari, farewell brunch.',
      fi: '80 vieraan häät Kakslauttasen Celebration Housessa — Suomen suurimmassa hirsirakennuksessa, kapasiteetti 250. Helikopteri Ivalon kentältä, Michelin-tason kokki, lasi-iglu-yöt jokaiselle parille, neljän päivän ohjelma: saapumissauna, vihkimys, hääjuhlan jälkeinen husky-safari, läksiäisbrunssi.',
      de: 'Eine Hochzeit für 80 Gäste im Kakslauttanen Celebration House — Finnlands größtem Blockhaus mit einer Kapazität von 250. Hubschraubertransfers vom Flughafen Ivalo, Michelin-erfahrener Koch, Glasiglu-Nächte für jedes Paar und ein viertägiges Programm: Ankunftssauna, Zeremonie, Husky-Safari nach der Hochzeit, Abschiedsbrunch.',
      ja: 'カクスラウッタネン・セレブレーションハウスでの80人の結婚式 — 収容人数250のフィンランド最大の丸太建築。イヴァロ空港からのヘリコプター送迎、ミシュランで研鑽を積んだシェフ、各カップルにガラスのイグルー泊、そして4日間のプログラム：到着サウナ、挙式、挙式後のハスキーサファリ、お別れブランチ。',
      es: 'Una boda para 80 invitados en Kakslauttanen Celebration House — el edificio de troncos más grande de Finlandia, con capacidad para 250. Traslados en helicóptero desde el aeropuerto de Ivalo, chef con formación Michelin, noches en iglú de cristal para cada pareja y un programa de cuatro días: sauna de llegada, ceremonia, safari de huskies posboda y brunch de despedida.',
      'pt-BR': 'Um casamento para 80 convidados na Kakslauttanen Celebration House — a maior construção de troncos da Finlândia, com capacidade para 250. Transfers de helicóptero do aeroporto de Ivalo, chef com formação Michelin, noites em iglu de vidro para cada casal e um programa de quatro dias: sauna de chegada, cerimônia, safári de huskies pós-casamento, brunch de despedida.',
      'zh-CN': '在 Kakslauttanen Celebration House 举办的 80 人婚礼——芬兰最大的原木建筑，可容纳 250 人。从伊瓦洛机场直升机接送、米其林背景主厨、为每对情侣安排玻璃冰屋住宿，以及为期四天的行程：抵达桑拿、仪式、婚后哈士奇雪橇之旅、告别早午餐。',
      ko: 'Kakslauttanen Celebration House에서 열린 80명 규모의 결혼식 — 수용 인원 250명의 핀란드 최대 통나무 건물. 이발로 공항에서의 헬리콥터 이동, 미슐랭 출신 셰프, 모든 커플을 위한 글라스 이글루 숙박, 그리고 4일간의 프로그램: 도착 사우나, 예식, 결혼식 후 허스키 사파리, 작별 브런치.',
      fr: 'Un mariage pour 80 invités à la Kakslauttanen Celebration House — le plus grand bâtiment en rondins de Finlande, d’une capacité de 250 personnes. Transferts en hélicoptère depuis l’aéroport d’Ivalo, chef formé dans la tradition Michelin, nuits en igloo de verre pour chaque couple et un programme de quatre jours : sauna d’arrivée, cérémonie, safari husky après le mariage, brunch d’adieu.',
      it: 'Un matrimonio per 80 ospiti alla Kakslauttanen Celebration House — il più grande edificio in tronchi della Finlandia, con capacità di 250 persone. Transfer in elicottero dall’aeroporto di Ivalo, chef di formazione Michelin, notti in igloo di vetro per ogni coppia e un programma di quattro giorni: sauna di arrivo, cerimonia, husky-safari post-matrimonio, brunch di addio.',
      nl: 'Een bruiloft voor 80 gasten in Kakslauttanen Celebration House — het grootste blokhuis van Finland, capaciteit 250. Helikoptertransfers vanaf de luchthaven van Ivalo, een Michelin-geschoolde chef, glazen-iglo-nachten voor elk paar en een vierdaags programma: aankomstsauna, ceremonie, husky-safari na de bruiloft, afscheidsbrunch.',
    },
    spends: {
      en: ['Celebration House venue + ceremony: €18 000', 'Catering Michelin-level ×80: €22 000', 'Helicopter transfers: €8 400', 'Photo + video team (3 people, full programme): €11 000', 'Glass igloo nights for guests ×3: €14 800', 'Florist + decor: €3 800'],
      fi: ['Celebration House + vihkimys: 18 000 €', 'Catering Michelin-tasolla ×80: 22 000 €', 'Helikopterikuljetukset: 8 400 €', 'Kuvaus + video (3 henkilöä, koko ohjelma): 11 000 €', 'Lasi-iglu-yöt vieraille ×3: 14 800 €', 'Kukkasidonta + dekoraatio: 3 800 €'],
      de: ['Celebration House + Zeremonie: 18 000 €', 'Catering auf Michelin-Niveau ×80: 22 000 €', 'Hubschraubertransfers: 8 400 €', 'Foto- + Videoteam (3 Personen, ganzes Programm): 11 000 €', 'Glasiglu-Nächte für Gäste ×3: 14 800 €', 'Florist + Dekoration: 3 800 €'],
      ja: ['セレブレーションハウス会場＋挙式：18,000ユーロ', 'ミシュランレベルのケータリング×80：22,000ユーロ', 'ヘリコプター送迎：8,400ユーロ', '写真＋動画チーム（3名、全プログラム）：11,000ユーロ', 'ゲスト用ガラスイグルー泊×3：14,800ユーロ', 'フローリスト＋装飾：3,800ユーロ'],
      es: ['Celebration House + ceremonia: 18 000 €', 'Catering nivel Michelin ×80: 22 000 €', 'Traslados en helicóptero: 8 400 €', 'Equipo de foto + vídeo (3 personas, programa completo): 11 000 €', 'Noches en iglú de cristal para invitados ×3: 14 800 €', 'Floristería + decoración: 3 800 €'],
      'pt-BR': ['Celebration House + cerimônia: € 18.000', 'Buffet nível Michelin ×80: € 22.000', 'Transfers de helicóptero: € 8.400', 'Equipe de foto + vídeo (3 pessoas, programa completo): € 11.000', 'Noites em iglu de vidro para convidados ×3: € 14.800', 'Floricultura + decoração: € 3.800'],
      'zh-CN': ['Celebration House 场地 + 仪式：18,000 欧元', '米其林水准餐饮 ×80：22,000 欧元', '直升机接送：8,400 欧元', '摄影 + 视频团队（3 人，全程）：11,000 欧元', '宾客玻璃冰屋住宿 ×3：14,800 欧元', '花艺 + 布置：3,800 欧元'],
      ko: ['Celebration House 장소 + 예식: 18,000유로', '미슐랭급 케이터링 ×80: 22,000유로', '헬리콥터 이동: 8,400유로', '사진 + 영상 팀(3인, 전체 프로그램): 11,000유로', '하객용 글라스 이글루 숙박 ×3: 14,800유로', '플로리스트 + 데코: 3,800유로'],
      fr: ['Lieu Celebration House + cérémonie : 18 000 €', 'Traiteur niveau Michelin ×80 : 22 000 €', 'Transferts en hélicoptère : 8 400 €', 'Équipe photo + vidéo (3 personnes, programme complet) : 11 000 €', 'Nuits en igloo de verre pour les invités ×3 : 14 800 €', 'Fleuriste + décoration : 3 800 €'],
      it: ['Celebration House + cerimonia: 18 000 €', 'Catering di livello Michelin ×80: 22 000 €', 'Transfer in elicottero: 8 400 €', 'Troupe foto + video (3 persone, programma completo): 11 000 €', 'Notti in igloo di vetro per gli ospiti ×3: 14 800 €', 'Fiorista + decorazioni: 3 800 €'],
      nl: ['Celebration House-locatie + ceremonie: € 18.000', 'Catering op Michelin-niveau ×80: € 22.000', 'Helikoptertransfers: € 8.400', 'Foto- + videoteam (3 personen, volledig programma): € 11.000', 'Glazen-iglo-nachten voor gasten ×3: € 14.800', 'Bloemist + decoratie: € 3.800'],
    },
    takeaway: {
