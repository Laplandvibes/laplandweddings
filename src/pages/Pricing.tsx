...
const P: Record<PKey, Localized<string>> = {
  ...
  ctaBody: {
    ...
    es: 'Un formulario, de 1 a 7 días, 1–3 propuestas personalizadas de los organizadores más experimentados de Laponia. Gratis, sin compromiso: usted decide con quién seguir.',
