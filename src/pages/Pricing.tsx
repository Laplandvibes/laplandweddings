...
const P: Record<PKey, Localized<string>> = {
  ...
  seoTitle: { en: 'Lapland wedding with guests: our EUR 5,000 minimum', fi: 'Häät vieraiden kanssa: pienin budjetti 5 000 €', de: 'Hochzeit mit Gästen in Lappland: Mindestbudget 5.000 €', ja: 'ゲストを招く結婚式：最小のご予算5,000ユーロ', es: 'Boda con invitados en Laponia: presupuesto mínimo 5 000 €', 'pt-BR': 'Casamento com convidados na Lapônia: orçamento mínimo € 5.000', 'zh-CN': '有宾客的拉普兰婚礼：最低预算 5,000 欧元', ko: '하객이 있는 라플란드 결혼식: 최소 예산 5,000유로', fr: 'Mariage avec invités en Laponie : budget minimum 5 000 €', it: 'Matrimonio con ospiti in Lapponia: budget minimo 5.000 €', nl: 'Bruiloft met gasten in Lapland: minimumbudget € 5.000', sv: 'Bröllop med gäster i Lappland: minsta budget 5 000 €' },
