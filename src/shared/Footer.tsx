...
const BUILT_IN_SITE_LABELS: Record<string, Record<SiteLabelsKey, string>> = {
  ...
  de: { hotelDeals:'Handverlesene Hotelangebote',staysCabins:'Unterkünfte & Hütten',whereToStay:'Glas-Iglus, Hütten, Lodges',familyFriendly:'Familienresorts + Weihnachtsmann-Besuche',localFood:'Samische Küche & Beerensammeln',fineDining:'Fine Dining',barsPubs:'Bars & Pubs',activities:'Handverlesene Arktis-Aktivitäten',huskySafaris:'Husky-Safaris, Anbieter im Vergleich',skiResorts:'Skigebiete im Vergleich',snowmobileTours:'Schneemobil-Safaris & Vermietung',spaWellness:'Saunas, Spas, Polarlicht-Wellness',nightlife:'Nachtleben',natureParks:'Natur & Parks',travelGuide:'Reiseführer',christmas:'Weihnachten in Lappland, Weihnachtsmanndorf, Polarlicht',giftsSouvenirs:'Geschenke & Souvenirs',travelBlog:'Reiseblog',dealsOffers:'Angebote',transport:'Transport',carRental:'Mietwagen',workInLapland:'Arbeiten in Lappland' },
