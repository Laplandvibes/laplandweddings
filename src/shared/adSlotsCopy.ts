...
export const AD_SLOTS_COPY: Record<AdLocale, AdSlotsCopy> = {
  ...
  es: {
    ...
    partnersDirEmpty: 'Muestre su empresa a los viajeros que planean su viaje a Laponia: contenidos patrocinados y un espacio destacado en la red.',
    subpageOpen: 'Tu anuncio en esta página, toda la temporada',
    wantYourAd: '¿Quiere su anuncio aquí?',
    sponsorSub: 'Conviértete en colaborador principal: el espacio más visible del sitio.',
    cardSub: 'Un espacio en la portada: ponga su empresa ante los viajeros de Laponia.',
