...
const T: Record<FormKey, Localized<string>> = {
  ...
  phoneHelp: {
    ...
    es: 'WhatsApp sirve: suele ser la forma más rápida de ponernos en contacto con usted.',
  ...
  regions: {
    ...
    ja: 'ラップランドでの対応エリア',
    es: 'Regiones que cubre en Laponia',
  ...
  years: {
    ...
    es: '¿Cuánto tiempo lleva organizando bodas en Laponia?',
  ...
  servicesLabel: {
    ...
    es: '¿Qué ofrece usted mismo o a través de socios de confianza?',
  ...
  message: {
    ...
    ja: '貴社について簡単にご紹介ください',
    es: 'Cuéntenos brevemente sobre ustedes',
  ...
  messagePlaceholder: {
    ...
    es: 'Estilo, especialidades, bodas de ejemplo, por qué encaja…',
  ...
  successBody: {
    ...
    es: 'La revisaremos y le responderemos en pocos días. Los socios aprobados reciben su primer lead gratis.',
