...
const GATE: Record<GateKey, Localized<string>> = {
  eyebrow: {
    ...
    it: 'Risorsa gratuita',
    nl: 'Gratis weggever', sv: 'Kostnadsfritt material',
  },
  title: {
    ...
    es: 'Desbloquee la lista de verificación DVV: solo su correo',
  ...
  sub: {
    ...
    es: 'Reciba todos los pasos y enlaces al instante, además de novedades del mercado de bodas de Laponia: lugares, consejos de temporada y ofertas. Puede darse de baja cuando quiera.',
  ...
  bulletA: {
    ...
    nl: 'Checklist van één pagina: elk document en getuige', sv: 'Checklista på en sida: alla dokument och vittnen',
  },
  bulletB: {
    ...
    nl: 'Tijdlijn: 8 weken vooraf → na de bruiloft', sv: 'Tidslinje: 8 veckor före → efter bröllopet',
  },
  bulletC: {
    ...
    nl: 'Directe links naar de officiële DVV-pagina’s', sv: 'Direktlänkar till DVV:s officiella sidor',
  },
  bulletD: {
    ...
    ja: 'A4で印刷、またはPDFで保存',
    es: 'Imprima en A4 o guarde como PDF',
  ...
  firstNameLabel: {
    ...
    it: 'Nome (facoltativo)',
    nl: 'Voornaam (optioneel)', sv: 'Förnamn (valfritt)',
  },
  emailLabel: {
    en: 'Email address *',
    fi: 'Sähköpostiosoite *',
    ...
    fr: 'Adresse e-mail *',
    it: 'Indirizzo email *',
    nl: 'E-mailadres *', sv: 'E-postadress *',
  },
  emailPlaceholder: {
    en: 'you@email.com',
    fi: 'sinun@email.fi',
    de: 'name@email.de',
    ja: 'you@email.com',
    es: 'su-correo@example.com',
    'pt-BR': 'você@email.com',
    'zh-CN': 'you@email.com',
    ko: 'you@email.com',
    fr: 'vous@email.com',
    it: 'nome@esempio.com',
  ...
  privacy: {
    ...
    es: 'Sus datos están seguros en la red LaplandVibes. Nunca compartimos su correo con terceros.',
...
const GATE_ERROR: Localized<string> = {
  ...
  es: 'El envío falló. Inténtelo de nuevo.',
