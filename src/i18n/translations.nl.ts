...
const t_nl = {
  ...
  form: {
    ...
    phoneHelp: 'WhatsApp werkt prima, vaak de snelste manier waarop een planner je kan bereiken.',
    country: 'Uw land',
    ...
    accommodationHelp: 'Moet het budget jullie verblijf (en dat van gasten) dekken?',
