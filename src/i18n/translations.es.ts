...
const t_es = {
  ...
  cta: {
    ...
    seeAllPlanners: 'Todos los planificadores',
    learnMore: 'Saber más',
  ...
  pricing: {
    ...
    subtitle: 'Un resumen de precios de mercado por tipo de boda y número de invitados. Todos los precios son listados públicos de las empresas operadoras a principios de 2026.',
  },
  contact: {
    title: 'Contáctenos',
  ...
  form: {
    ...
    phoneHelp: 'WhatsApp funciona muy bien: suele ser la forma más rápida de que un organizador os localice.',
    country: 'Su país',
    ...
    ceremonyUnsure: 'Aún no lo sé, aconsejadnos',
    ...
    accommodationHelp: '¿El presupuesto debe cubrir vuestro alojamiento (y el de los invitados)?',
    ...
    messagePlaceholder: 'P. ej. ceremonia bajo la aurora boreal, invitados volando desde España, queremos incluir un safari de huskies...',
    consent: 'Acepto que mis datos puedan compartirse con 1–3 planificadores de boda y el equipo de LaplandVibes. Puedo retirarme en cualquier momento.',
  ...
  footerLine: 'Parte de la red LaplandVibes · No somos planificadores, comparamos las mejores opciones para usted.',
  legal: {
    terms: {
