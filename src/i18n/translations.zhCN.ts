...
const t_zhCN = {
  ...
  home: {
    ...
    whyP: '在拉普兰,您可以以 1,600 欧元起举办私奔婚礼,或以 50,000 欧元举办 100 人豪华庆典。芬兰让外国情侣登记结婚很简单，通过 DVV 办理手续仅需 3–5 周。我们的网络通过一份表格为您提供 3 份本地策划师的定制报价。',
  ...
  venues: {
    indexTitle: '已验证的拉普兰婚礼场地',
    indexIntro: '超过 20 个婚礼场地,全部经过验证:空间、容量和联系方式。按地区、婚礼类型或价格档次筛选。',
