...
const t_zhCN = {
  ...
  home: {
    heroTitle: '在极光之下，说“我愿意”。',
    heroTitleSummer: '午夜阳光下的拉普兰婚礼',
    heroSubtitle: '玻璃屋顶上方是极光，雪教堂里点着烛光，院子里有驯鹿在等候。我们会免费、无义务地把您的心愿转达给拉普兰的婚礼策划师和场地。',
    heroSubtitleSummer: '湖畔誓言 · 山顶仪式 · 永昼天空下的玻璃屋顶 · 漫长的明亮夜晚。提供芬兰语和英语服务。我们会免费、无义务地把您的请求转给拉普兰的婚礼策划师和场地。',
    ...
    audienceTitle: '为芬兰新人提供芬兰语服务，为国际新人提供英语服务',
  ...
  venues: {
    ...
    indexIntro: '拉普兰举行婚礼的 20 个场地。资料来自各场地自己公开的信息。按地区、婚礼类型或价格档次筛选。',
