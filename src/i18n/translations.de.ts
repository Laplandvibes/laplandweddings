...
const t_de = {
  ...
  home: {
    ...
    heroSubtitle: 'Polarlichter über dem Glasdach, Kerzen in der Schneekapelle, ein Rentier wartet im Hof. Wir leiten Ihre Wünsche kostenlos und unverbindlich an Hochzeitsplaner und Locations in Lappland weiter.',
    ...
    whyP: 'In Lappland wird in Glasiglus, Schneekapellen und auf Fjällgipfeln geheiratet, und meistens ist die Zeremonie symbolisch. Diese Seite sammelt die Orte, die Jahreszeiten und die tatsächlichen Kosten. Wir richten keine Hochzeiten aus und vertreten keine Location: Sie nennen uns Ihren Wunsch, wir geben ihn an Hochzeitsplaner in Lappland weiter.',
    audienceTitle: 'Auf Deutsch für deutschsprachige Paare, auf Finnisch und Englisch für alle anderen',
    audienceFi: 'Sie sind ein deutschsprachiges Paar? Erhalten Sie finnische Hochzeitsplaner mit Erfahrung in deutscher Korrespondenz und allen rechtlichen Unterlagen, wir kümmern uns um die DVV.',
    audienceEn: 'Internationales Paar? Erhalten Sie finnische Hochzeitsplaner mit Erfahrung in ausländischem Papierkram, wir kümmern uns um die DVV.',
  ...
  venues: {
    ...
    indexIntro: '20 Orte, an denen in Lappland geheiratet wird. Die Angaben stammen aus den eigenen Quellen der jeweiligen Location. Filtern Sie nach Region, Hochzeitsart oder Preisklasse.',
  ...
  form: {
    ...
    phoneHelp: 'WhatsApp funktioniert gut und ist oft der schnellste Weg, über den ein Planer Sie erreicht.',
    country: 'Ihr Land',
    ...
    accUnsure: 'Unsicher',
    budget: 'Budget (€)',
    budget1: 'Unter 5.000 € (Trauung zu zweit)',
    ...
    attachmentsTotalTooBig: 'Die Gesamtgröße der Anhänge überschreitet 38 MB.',
  ...
  legal: {
    ...
    privacy: {
      ...
      newsletterBefore: 'Wenn Sie unseren Newsletter abonnieren, wird Ihre E-Mail-Adresse über Resend und Supabase sicher gespeichert. Sie können sich jederzeit über den Link in jeder E-Mail abmelden oder über ',
      unsubLabel: 'unsere Abmeldeseite',
      newsletterAfter: '.',
      ...
      paragraphs: [
        ...
        'Nach der DSGVO haben Sie das Recht auf Auskunft, Berichtigung, Löschung, Einschränkung und Übertragbarkeit Ihrer personenbezogenen Daten sowie das Recht, der Verarbeitung zu widersprechen. Zur Ausübung dieser Rechte wenden Sie sich an info@laplandvibes.com.',
