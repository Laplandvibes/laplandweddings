...
const t_de = {
  ...
  home: {
    ...
    heroSubtitleSummer: 'Trauung am Seeufer · Bogen am Fuß des Fjells · helle Nächte ohne Dunkelheit. Lapplands erfahrenste Hochzeitsplaner, fordern Sie 1–3 maßgeschneiderte Angebote mit einem Formular an.',
