...
const t_en = {
  ...
  home: {
    ...
    plannersTitle: 'Wedding planners in Lapland',
    plannersIntro: 'We forward your request to wedding planners in Lapland. Send the form and we will pass it on for 1–3 personalised quotes, at no cost to you.',
  ...
  planners: {
    ...
    indexIntro: 'We forward your enquiry to wedding planners in Lapland. Send one form → we pass it on for 1–3 personalised quotes.',
  ...
  legal: {
    ...
    privacy: {
      ...
      newsletterBefore: 'If you subscribe to our newsletter, your email address is stored securely via Resend and Supabase. You can unsubscribe at any time using the link in every email or via our ',
      unsubLabel: 'unsubscribe page',
      newsletterAfter: '.',
