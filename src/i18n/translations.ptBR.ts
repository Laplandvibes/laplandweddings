...
const t_ptBR = {
  ...
  venues: {
    ...
    indexIntro: '20 lugares onde se realizam casamentos na Lapônia. As informações vêm das fontes de cada local. Filtre por região, tipo de casamento ou faixa de preço.',
  ...
  legal: {
    ...
    privacy: {
      ...
      newsletterBefore: 'Ao se inscrever no nosso boletim, seu endereço de e-mail é armazenado com segurança pela Resend e Supabase. Você pode cancelar a qualquer momento pelo link em cada e-mail ou pela nossa ',
      unsubLabel: 'página de cancelamento',
      newsletterAfter: '.',
      ...
      paragraphs: [
        ...
        'O formulário coleta seu nome e o de seu parceiro ou parceira, seu e-mail e, opcionalmente, seu telefone, seu país e os detalhes do casamento que você descreve: data preferida e flexibilidade, número de convidados, região, local desejado, tipo de cerimônia, preferência de hospedagem, faixa de orçamento e sua mensagem livre.',
