 ...
 * 11-locale `Localized<string>`. Read with `ui(key, lang)`.
 *
 ...
 * English for the nine other locales.
 */
const STRINGS = {
  // eyebrows
  eyebrowVenues: {
  ...
  eyebrowPlanners: {
    ...
    fr: 'Wedding planners', it: 'Wedding planner', nl: 'Trouwplanners',
  },
  ...
  guests: {
    ...
    fr: 'invités', it: 'ospiti', nl: 'gasten',
  },
  venuesLower: {
