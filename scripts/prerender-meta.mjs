...
const top = {
  ...
  '/locations': {
    ...
    de: { title: 'Hochzeitsregionen in Lappland | LaplandWeddings',
          description: 'Sieben Hochzeitsregionen in Lappland plus die Stadt Oulu: Rovaniemi, Saariselkä, Levi, Ylläs, Pyhä-Luosto, Kilpisjärvi, Kemijärvi. Saisons im Vergleich.' },
...
const venues = [
  ...
  { slug: 'tundrea-kilpisjarvi', name: 'Tundrea Kilpisjärvi', en: { region: 'Kilpisjärvi', desc: 'Finland’s northernmost glass igloo resort, 480 m above sea level: one of the best aurora views in Lapland.' }, fi: { region: 'Kilpisjärvi', desc: 'Suomen pohjoisin lasi-iglu-resortti, 480 m mpy: Lapin paras revontulinäkymä.' }, img: '/images/venues/tundrea-kilpisjarvi.jpg' },
