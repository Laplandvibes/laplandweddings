...
const venues = [
  ...
  { slug: 'snow-village-lainio', name: 'Lapland Hotels SnowVillage (Lainio)', en: { region: 'Lainio, Kittilä', desc: 'World-famous Snow Village rebuilt every winter with new artistic theme. Ice chapel, wooden chapel, snow suites.' }, fi: { region: 'Lainio, Kittilä', desc: 'Maailmankuulu Snow Village, uusi taideteema joka talvi. Jääkappeli, puukappeli, lumisviittejä.' }, img: '/images/venues/snow-village-lainio.jpg' },
