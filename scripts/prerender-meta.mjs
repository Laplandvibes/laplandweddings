...
const top = {
  ...
  '/locations': {
    ...
    ja: { title: 'ラップランドの結婚式地域：ロヴァニエミ、レヴィ、サーリセルカ、ユッラス | LaplandWeddings',
    ...
    'zh-CN': { title: '拉普兰婚礼地区：罗瓦涅米、莱维、萨利色尔卡、于拉斯 | LaplandWeddings',
  ...
  '/wedding-types': {
    ...
    ko: { title: '라플란드 결혼식 유형: 오로라, 스노우 채플, 글래스 이글루 | LaplandWeddings',
  ...
  '/practical-guide': {
    ...
    ko: { title: '라플란드에서 결혼하기: DVV 서류, 주례, 실용 가이드 | LaplandWeddings',
          description: '외국인 커플을 위한 실용 가이드입니다: DVV 서류, 혼인 요건 심사(3~5주), 증인, 주례, 본국 등록.' },
  ...
  '/contact': {
    en: { title: 'Request 1–3 Lapland wedding quotes | LaplandWeddings',
    ...
    es: { title: 'Pida 1–3 presupuestos para su boda en Laponia | LaplandWeddings',
    ...
    'pt-BR': { title: 'Peça 1–3 orçamentos para seu casamento na Lapônia | LaplandWeddings',
    ...
    'zh-CN': { title: '索取 1–3 份拉普兰婚礼报价 | LaplandWeddings',
          description: '免费且无承诺。1–7 天内回复。 我们将在 1–2 个工作日内回复。简单告诉我们您的梦想，我们会转发给合适的策划师。' },
    ko: { title: '라플란드 결혼식 견적 1~3건 요청 | LaplandWeddings',
          description: '무료, 부담 없음. 1~7일 내 답변. 1~2 영업일 내에 답변드립니다. 꿈에 대해 간단히 알려주시면 적합한 플래너에게 연결해 드립니다.' },
    fr: { title: 'Demandez 1 à 3 devis pour votre mariage en Laponie | LaplandWeddings',
    ...
    it: { title: 'Richiedete 1–3 preventivi per il matrimonio in Lapponia | LaplandWeddings',
    ...
    nl: { title: 'Vraag 1–3 offertes aan voor uw bruiloft in Lapland | LaplandWeddings',
    ...
    sv: { title: 'Begär 1–3 offerter för ert bröllop i Lappland | LaplandWeddings',
...
const TYPE_TITLE_SUFFIX = {
  ...
  de: ': Hochzeiten in Lappland | LaplandWeddings',
