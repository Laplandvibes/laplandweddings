...
const top = {
  ...
  '/locations': {
    en: { title: 'Lapland Wedding Regions — Rovaniemi, Levi, Saariselkä, Ylläs | LaplandWeddings',
          ...
          description: 'Kuusi Lapin häämatkakohdetta — Rovaniemi, Saariselkä, Levi, Ylläs, Pyhä-Luosto, Kilpisjärvi. Vertaile sesonkeja, lentoyhteyksiä ja venueita.' },
    de: { title: 'Hochzeitsregionen in Lappland | LaplandWeddings',
          description: 'Sechs Hochzeitsregionen in Lappland — Rovaniemi, Saariselkä, Levi, Ylläs, Pyhä-Luosto, Kilpisjärvi. Saisons, Flugverbindungen und Locations im Vergleich.' },
    ja: { title: 'ラップランドの結婚式地域 — ロヴァニエミ、レヴィ、サーリセルカ、ウッラス | LaplandWeddings',
          description: 'ラップランドの6つの結婚式地域 — ロヴァニエミ、サーリセルカ、レヴィ、ウッラス、ピュハ・ルオスト、キルピスヤルヴィ。季節、フライト、会場を比較。' },
    es: { title: 'Regiones de boda en Laponia | LaplandWeddings',
          description: 'Seis regiones de boda en Laponia: Rovaniemi, Saariselkä, Levi, Ylläs, Pyhä-Luosto, Kilpisjärvi. Compare temporadas, vuelos y lugares.' },
    'pt-BR': { title: 'Regiões de casamento na Lapônia | LaplandWeddings',
          description: 'Seis regiões de casamento na Lapônia: Rovaniemi, Saariselkä, Levi, Ylläs, Pyhä-Luosto, Kilpisjärvi. Compare estações, voos e locais.' },
    'zh-CN': { title: '拉普兰婚礼地区 — 罗瓦涅米、莱维、萨里塞尔卡、于拉斯 | LaplandWeddings',
          description: '拉普兰六大婚礼地区 — 罗瓦涅米、萨里塞尔卡、莱维、于拉斯、皮哈-卢奥斯托、基尔皮斯耶尔维。比较季节、航班和场地。' },
    ko: { title: '라플란드 결혼식 지역 — 로바니에미, 레비, 사리셀카, 윌래스 | LaplandWeddings',
          description: '라플란드 결혼식 지역 6곳 — 로바니에미, 사리셀카, 레비, 윌래스, 퓌해-루오스토, 킬피스얘르비. 시즌, 항공편, 예식장을 비교합니다.' },
    fr: { title: 'Régions de mariage en Laponie | LaplandWeddings',
          description: 'Six régions de mariage en Laponie : Rovaniemi, Saariselkä, Levi, Ylläs, Pyhä-Luosto, Kilpisjärvi. Comparez les saisons, vols et lieux.' },
    it: { title: 'Regioni per matrimoni in Lapponia | LaplandWeddings',
          description: 'Sei regioni per matrimoni in Lapponia: Rovaniemi, Saariselkä, Levi, Ylläs, Pyhä-Luosto, Kilpisjärvi. Confronti stagioni, voli e location.' },
    nl: { title: 'Bruiloftsregio’s in Lapland | LaplandWeddings',
          description: 'Zes bruiloftsregio’s in Lapland: Rovaniemi, Saariselkä, Levi, Ylläs, Pyhä-Luosto, Kilpisjärvi. Vergelijk seizoenen, vluchten en locaties.' },
