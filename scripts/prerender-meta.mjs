...
const top = {
  '/': {
    en: { title: 'Lapland Weddings 2026 — Arctic Venues & Marriage Paperwork',
          description: 'The most complete Lapland wedding planning site. 20+ venues, DVV marriage paperwork, real prices and practical guides for your Arctic wedding.' },
    fi: { title: 'Häät Lapissa 2026 — hääpaikat ja DVV-paperit',
          description: 'Lapin kattavin häämatkasivu. Yli 20 hääpaikkaa, DVV-paperit, oikeat hinnat ja käytännön oppaat Lapin häihisi.' },
    de: { title: 'Hochzeit in Lappland 2026 — Locations & Heiratspapiere',
          description: 'Die umfassendste Seite für Hochzeiten in Lappland. Über 20 Hochzeitslocations, DVV-Unterlagen, echte Preise und praktische Leitfäden.' },
    ja: { title: 'ラップランドの結婚式2026 — 会場と婚姻手続き',
          description: 'ラップランドで最も充実した結婚式プランニングサイト。20以上の会場、DVV書類、実際の価格、実用的なガイド。' },
    es: { title: 'Bodas en Laponia 2026 — lugares y trámites de boda',
          description: 'El sitio más completo de planificación de bodas en Laponia. Más de 20 lugares, trámites DVV, precios reales y guías prácticas.' },
    'pt-BR': { title: 'Casamentos na Lapônia 2026 — locais e documentação',
          description: 'O site mais completo de planejamento de casamentos na Lapônia. Mais de 20 locais, documentação DVV, preços reais e guias práticos.' },
    'zh-CN': { title: '拉普兰婚礼2026 — 婚礼场地与结婚手续',
          description: '最完整的拉普兰婚礼策划网站。20多个场地、DVV文件、真实价格和实用指南。' },
    ko: { title: '라플란드 결혼식 2026 — 베뉴와 혼인 서류',
          description: '가장 충실한 라플란드 결혼식 기획 사이트입니다. 20곳 이상의 예식장, DVV 서류, 실제 가격과 실용적인 가이드.' },
    fr: { title: 'Mariage en Laponie 2026 — lieux et démarches de mariage',
          description: 'Le site le plus complet pour planifier un mariage en Laponie. Plus de 20 lieux, démarches DVV, prix réels et guides pratiques.' },
  ...
  '/locations': {
    en: { title: 'Lapland Wedding Regions — Rovaniemi, Levi, Saariselkä, Ylläs | LaplandWeddings',
          description: 'Six Lapland wedding regions plus city-option Oulu — Rovaniemi, Saariselkä, Levi, Ylläs, Pyhä-Luosto, Kilpisjärvi, Oulu. Compare seasons, flights, and venues.' },
    fi: { title: 'Häät Lapin paikkakunnilla | LaplandWeddings',
          description: 'Kuusi Lapin häämatkakohdetta ja kaupunkivaihtoehto Oulu — Rovaniemi, Saariselkä, Levi, Ylläs, Pyhä-Luosto, Kilpisjärvi, Oulu. Vertaile sesonkeja, lentoyhteyksiä ja venueita.' },
    de: { title: 'Hochzeitsregionen in Lappland | LaplandWeddings',
          description: 'Sechs Hochzeitsregionen in Lappland plus Großstadt-Option Oulu — Rovaniemi, Saariselkä, Levi, Ylläs, Pyhä-Luosto, Kilpisjärvi, Oulu. Saisons, Flugverbindungen und Locations im Vergleich.' },
    ja: { title: 'ラップランドの結婚式地域 — ロヴァニエミ、レヴィ、サーリセルカ、ウッラス | LaplandWeddings',
          description: 'ラップランドの6つの結婚式地域＋都市の選択肢オウル — ロヴァニエミ、サーリセルカ、レヴィ、ウッラス、ピュハ・ルオスト、キルピスヤルヴィ、オウル。季節、フライト、会場を比較。' },
    es: { title: 'Regiones de boda en Laponia | LaplandWeddings',
          description: 'Seis regiones de boda en Laponia más la opción urbana de Oulu: Rovaniemi, Saariselkä, Levi, Ylläs, Pyhä-Luosto, Kilpisjärvi, Oulu. Compare temporadas, vuelos y lugares.' },
    'pt-BR': { title: 'Regiões de casamento na Lapônia | LaplandWeddings',
          description: 'Seis regiões de casamento na Lapônia mais a opção urbana de Oulu: Rovaniemi, Saariselkä, Levi, Ylläs, Pyhä-Luosto, Kilpisjärvi, Oulu. Compare estações, voos e locais.' },
    'zh-CN': { title: '拉普兰婚礼地区 — 罗瓦涅米、莱维、萨里塞尔卡、于拉斯 | LaplandWeddings',
          description: '拉普兰六大婚礼地区外加城市之选奥卢 — 罗瓦涅米、萨里塞尔卡、莱维、于拉斯、皮哈-卢奥斯托、基尔皮斯耶尔维、奥卢。比较季节、航班和场地。' },
    ko: { title: '라플란드 결혼식 지역 — 로바니에미, 레비, 사리셀카, 윌래스 | LaplandWeddings',
          description: '라플란드 결혼식 지역 6곳과 도시 옵션 오울루 — 로바니에미, 사리셀카, 레비, 윌래스, 퓌해-루오스토, 킬피스얘르비, 오울루. 시즌, 항공편, 예식장을 비교합니다.' },
    fr: { title: 'Régions de mariage en Laponie | LaplandWeddings',
          description: 'Six régions de mariage en Laponie plus Oulu, l’option urbaine : Rovaniemi, Saariselkä, Levi, Ylläs, Pyhä-Luosto, Kilpisjärvi, Oulu. Comparez les saisons, vols et lieux.' },
  ...
  '/venues': {
    en: { title: 'Lapland Wedding Venues — 20+ verified venues | LaplandWeddings',
          ...
          description: 'Kakslauttanen, Northern Lights Ranch, Arctic SnowHotel, Snow Village ja muita. Yli 20 vahvistettua hääpaikkaa Lapin paikkakunnilla.' },
    de: { title: 'Hochzeitslocations in Lappland | LaplandWeddings',
          description: 'Kakslauttanen, Northern Lights Ranch, Arctic SnowHotel, Snow Village und viele mehr. Über 20 verifizierte Hochzeitslocations in Lappland.' },
    ja: { title: 'ラップランドの結婚式会場 — 20以上の認証会場 | LaplandWeddings',
          description: 'カクスラウッタネン、ノーザンライツランチ、アークティックスノーホテル、スノービレッジなど。地域を横断する20以上の認証済み結婚式会場。' },
    es: { title: 'Lugares para bodas en Laponia | LaplandWeddings',
          description: 'Kakslauttanen, Northern Lights Ranch, Arctic SnowHotel, Snow Village y muchos más. Más de 20 lugares de boda verificados en las regiones de Laponia.' },
    'pt-BR': { title: 'Locais para casamento na Lapônia | LaplandWeddings',
          description: 'Kakslauttanen, Northern Lights Ranch, Arctic SnowHotel, Snow Village e muitos outros. Mais de 20 locais de casamento verificados nas regiões da Lapônia.' },
    'zh-CN': { title: '拉普兰婚礼场地 — 20多个经认证的场地 | LaplandWeddings',
          description: '卡克斯劳塔宁、北极光牧场、北极雪酒店、雪村等。覆盖各地区的20多个经认证的拉普兰婚礼场地。' },
    ko: { title: '라플란드 예식장 — 20곳 이상의 검증된 장소 | LaplandWeddings',
          description: '카크슬라우타넨, 노던 라이츠 랜치, 아크틱 스노우호텔, 스노우 빌리지 외. 라플란드 전역에 걸친 20곳 이상의 검증된 예식장입니다.' },
    fr: { title: 'Lieux de mariage en Laponie | LaplandWeddings',
          description: 'Kakslauttanen, Northern Lights Ranch, Arctic SnowHotel, Snow Village et bien d’autres. Plus de 20 lieux de mariage vérifiés dans toute la Laponie.' },
  ...
  '/photographers': {
    en: { title: 'Lapland Wedding Photographers — Maria Hedengren, Robin Goodlad et al. | LaplandWeddings',
          ...
          description: 'Kuusi Lapin parasta hääjvalokuvaajaa. Revontulet, lumikappelit, lasi-iglut — testattu pakkasessa.' },
  ...
  '/pricing': {
    en: { title: 'Lapland Weddings — Pricing and Packages | LaplandWeddings',
          description: 'How much do Lapland weddings cost? Elopement from €1 600, premium weddings up to €40 000. Verified market prices.' },
    fi: { title: 'Häät Lapissa — hinta-arviot ja paketit | LaplandWeddings',
          description: 'Mitä häät Lapissa maksaa? Elopement 1 600 €:sta, premium-häät 40 000 €:on. Vahvistetut markkinahinnat.' },
    de: { title: 'Hochzeiten in Lappland — Preise und Pakete | LaplandWeddings',
          description: 'Was kostet eine Hochzeit in Lappland? Elopement ab 1 600 €, Premiumhochzeiten bis 40 000 €. Verifizierte Marktpreise.' },
    ja: { title: 'ラップランドの結婚式 — 価格とパッケージ | LaplandWeddings',
          description: 'ラップランドの結婚式の費用は?エロープメント 1 600 €〜、プレミアム結婚式 最大 40 000 €。検証済みの市場価格。' },
    es: { title: 'Bodas en Laponia — precios y paquetes | LaplandWeddings',
          description: '¿Cuánto cuesta una boda en Laponia? Fuga desde 1 600 €, bodas premium hasta 40 000 €. Precios de mercado verificados.' },
    'pt-BR': { title: 'Casamentos na Lapônia — preços e pacotes | LaplandWeddings',
          description: 'Quanto custa um casamento na Lapônia? Elopement a partir de € 1.600, casamentos premium até € 40.000. Preços de mercado verificados.' },
    'zh-CN': { title: '拉普兰婚礼 — 价格与套餐 | LaplandWeddings',
          description: '拉普兰婚礼费用是多少?私奔婚礼 1 600 € 起,豪华婚礼最高 40 000 €。经核实的市场价格。' },
    ko: { title: '라플란드 결혼식 — 가격과 패키지 | LaplandWeddings',
          description: '라플란드 결혼식 비용은? 단출한 결혼은 1 600 €부터, 프리미엄 결혼식은 최대 40 000 €까지입니다. 검증된 시장 가격.' },
    fr: { title: 'Mariages en Laponie — tarifs et formules | LaplandWeddings',
          description: 'Combien coûte un mariage en Laponie ? Mariage à deux dès 1 600 €, mariages premium jusqu’à 40 000 €. Tarifs du marché vérifiés.' },
    it: { title: 'Matrimoni in Lapponia — prezzi e pacchetti | LaplandWeddings',
...
const locations = [
  ...
  { slug: 'saariselka', en: { name: 'Saariselkä & Inari', desc: 'The heart of Northern Lapland — highest aurora probability and Kakslauttanen’s glass teepee chapel.' }, fi: { name: 'Saariselkä & Inari', desc: 'Pohjois-Lapin sydän — Lapin korkein revontulitodennäköisyys ja Kakslauttasen lasi-teepee-kappeli.' }, img: '/images/venues/kakslauttanen.jpg' },
  ...
  { slug: 'pyha-luosto', en: { name: 'Pyhä-Luosto', desc: 'Lapland’s best-kept secret — UNESCO Starlight Reserve at Hotel Aurora and the amethyst mine ceremony at Lapland Hotels Pyhä.' }, fi: { name: 'Pyhä-Luosto', desc: 'Lapin parhaiten varjeltu salaisuus — UNESCOn tähtitaivasalue Hotel Aurorassa ja amethystikaivoksen vihkiminen Lapland Hotels Pyhässä.' }, img: '/images/locations/pyha-luosto.jpg' },
...
const types = [
  { slug: 'northern-lights', en: { name: 'Northern Lights Wedding', desc: 'Exchange vows under the aurora borealis — 200 nights per year of Northern Lights in Northern Lapland.' }, fi: { name: 'Revontulihäät', desc: 'Vihkiminen revontulien alla — Pohjois-Lapissa nähdään revontulet keskimäärin 200 yötä vuodessa.' }, img: '/images/types/northern-lights.jpg' },
...
const venues = [
  ...
  { slug: 'tundrea-kilpisjarvi', name: 'Tundrea Kilpisjärvi', en: { region: 'Kilpisjärvi', desc: 'Finland’s northernmost glass igloo resort, 480 m above sea level — best aurora view in Lapland.' }, fi: { region: 'Kilpisjärvi', desc: 'Suomen pohjoisin lasi-iglu-resortti, 480 m mph — Lapin paras revontulinäkymä.' }, img: '/images/venues/tundrea-kilpisjarvi.jpg' },
  { slug: 'hotel-aurora-pyha', name: 'Hotel Aurora Pyhä', en: { region: 'Pyhä-Luosto NP', desc: 'World’s northernmost stargazing site — UNESCO Starlight Reserve.' }, fi: { region: 'Pyhä-Luoston kp', desc: 'Maailman pohjoisin tähtibongauspaikka — UNESCO-tähtitaivasalue.' }, img: '/images/venues/hotel-aurora-pyha.webp' },
  { slug: 'lapland-hotels-pyha', name: 'Lapland Hotels Pyhä', en: { region: 'Pyhä, inside the NP', desc: 'Luxury hotel inside Pyhä National Park — amethyst mine wedding ceremony, the most original Lapland venue.' }, fi: { region: 'Pyhä, kp:n sisällä', desc: 'Luksushotelli Pyhän kp:n sisällä — amethystikaivoksen vihkiminen, Lapin omaperäisin häätila.' }, img: '/images/venues/lapland-hotels-pyha.jpg' },
  { slug: 'santas-hotel-santamus', name: "Santa's Hotel Santamus", en: { region: 'Santa Claus Village', desc: 'The only Santa Claus Village hotel designed for weddings. Reindeer and husky packages included.' }, fi: { region: 'Joulupukin pajakylä', desc: 'Joulupukin pajakylän ainoa hääihin suunniteltu hotelli. Poro- ja husky-paketit mukana.' }, img: '/images/venues/santas-hotel-santamus.png' },
