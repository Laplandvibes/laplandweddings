...
const top = {
  ...
  '/pricing': {
    ...
    ja: { title: 'ラップランドの結婚式：価格とパッケージ | LaplandWeddings',
          description: 'ラップランドの結婚式の費用は?エロープメント 1 600 €〜、プレミアム結婚式 最大 40 000 €。の市場価格。' },
    es: { title: 'Bodas en Laponia: precios y paquetes | LaplandWeddings',
          description: '¿Cuánto cuesta una boda en Laponia? Fuga desde 1 600 €, bodas premium hasta 40 000 €. Precios de mercado.' },
    'pt-BR': { title: 'Casamentos na Lapônia: preços e pacotes | LaplandWeddings',
          description: 'Quanto custa um casamento na Lapônia? Elopement a partir de € 1.600, casamentos premium até € 40.000. Preços de mercado.' },
    'zh-CN': { title: '拉普兰婚礼：价格与套餐 | LaplandWeddings',
          description: '拉普兰婚礼费用是多少?私奔婚礼 1 600 € 起,豪华婚礼最高 40 000 €。市场价格。' },
    ko: { title: '라플란드 결혼식: 가격과 패키지 | LaplandWeddings',
          description: '라플란드 결혼식 비용은? 단출한 결혼은 1 600 €부터, 프리미엄 결혼식은 최대 40 000 €까지입니다. 시장 가격.' },
    fr: { title: 'Mariages en Laponie: tarifs et formules | LaplandWeddings',
          description: 'Combien coûte un mariage en Laponie ? Mariage à deux dès 1 600 €, mariages premium jusqu’à 40 000 €. Tarifs du marché.' },
